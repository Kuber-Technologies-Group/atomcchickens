...
const BlogHeader: React.FC<BlogHeaderProps> = ({ 
  title = "Our Blog", 
  description = "Insights and updates from the world of indigenous poultry farming" 
}) => {
  return (
    <div className="relative pt-32 bg-cream">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-charcoal mb-6">{title}</h1>
